_base_ = [
    '../_base_/models/resnet50_s32c16em2_stoic_192x192x160_2cls.py',
...
load_from = 'work_dirs/resnset50_s32c16em2_stoic2kcv05_192x192x160_2cls_ep50/latest.pth'
...
optimizer = dict(
                ...
                # _delete_ = True, type='AdamW', lr=2e-4, weight_decay=5e-4
        ) 
...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/stoic2021/resnset50_s32c16em2_stoic2kcv05_192x192x160_2cls_ep50.py 
# CUDA_VISIBLE_DEVICES=4,5 PORT=29045 bash ./tools/dist_train.sh configs/stoic2021/resnset50_s32c16em2_stoic2kcv05_192x192x160_2cls_ep50.py 2
