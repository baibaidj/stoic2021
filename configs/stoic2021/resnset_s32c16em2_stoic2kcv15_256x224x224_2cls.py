...
resume_from = None # 'work_dirs/resnset_s32c16em2_stoic2kcv15_256x224x224_2cls/latest.pth' 
...
# CUDA_VISIBLE_DEVICES=1 python tools/train.py configs/stoic2021/resnset_s32c16em2_stoic2kcv15_256x224x224_2cls.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29135 bash ./tools/dist_train.sh configs/stoic2021/resnset_s32c16em2_stoic2kcv15_256x224x224_2cls.py 3
