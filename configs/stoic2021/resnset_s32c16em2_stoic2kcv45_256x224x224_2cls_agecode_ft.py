...
# CUDA_VISIBLE_DEVICES=1 python tools/train.py configs/stoic2021/resnset_s32c16em2_stoic2kcv45_256x224x224_2cls_agecode_ft.py 
# CUDA_VISIBLE_DEVICES=1,4 PORT=29014 bash ./tools/dist_train.sh configs/stoic2021/resnset_s32c16em2_stoic2kcv45_256x224x224_2cls_agecode_ft.py 2
