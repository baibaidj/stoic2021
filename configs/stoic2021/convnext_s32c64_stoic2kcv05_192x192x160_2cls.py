_base_ = [
    '../_base_/models/convnext_s32c64_stoic_192x192x160_img.py',
    '../_base_/schedules/schedule_2x.py', '../_base_/default_runtime.py'
    # '../_base_/swa.py',
]

img_dir = 'data/STOIC2021Round1'
data = dict(samples_per_gpu = 7, workers_per_gpu= 12, 
...
# CUDA_VISIBLE_DEVICES=1 python tools/train.py configs/stoic2021/convnext_s32c64_stoic2kcv05_192x192x160_2cls.py 
