_base_ = [
    '../_base_/models/resnet_s32c16em2k5_stoic_256x224x224_2cls.py',
...
# CUDA_VISIBLE_DEVICES=0 python tools/train.py configs/stoic2021/resnset_s32c16em2k5_stoic2kcv05_256x224x224_2cls.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29135 bash ./tools/dist_train.sh configs/stoic2021/resnset_s32c16em2k5_stoic2kcv05_256x224x224_2cls.py 3
