_base_ = [
    '../_base_/models/convnext_s32c64em4_stoic_224x224x192_img_covid.py',
    '../_base_/schedules/schedule_2x.py', '../_base_/default_runtime.py'
    # '../_base_/swa.py',
]

img_dir = 'data/STOIC2021Round1'
data = dict(samples_per_gpu = 12, workers_per_gpu= 16, 
            train=dict(sample_rate = 0.2, fn2imglist = 'stoic2021_case_info_split.csv', 
                        img_dir=img_dir, cv_fold = 0), 
            val=dict(sample_rate = 0.1, fn2imglist = 'stoic2021_case_info_split.csv', 
                        img_dir=img_dir, cv_fold = 0), 
            test= dict(sample_rate = 1.0, fn2imglist = 'stoic2021_case_info_split.csv',
                        img_dir=img_dir, cv_fold = 0))

pretrain_cp = 'work_dirs/simmim_convnext_s32c64em4_lung_224x224x192_100eps/latest.pth'
...
# CUDA_VISIBLE_DEVICES=4 python tools/train.py configs/stoic2021/convnext_s32c64em4_stoic2kcv05_224x224x192_covid.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29135 bash ./tools/dist_train.sh configs/stoic2021/convnext_s32c64em4_stoic2kcv05_224x224x192_covid.py 3 --gpus 3
