_base_ = [
    '../_base_/models/resnet_s32c16em2_stoic_192x192x144_2cls.py',
...
data = dict(samples_per_gpu = 16, workers_per_gpu= 16, 
            ...
            test= dict(sample_rate = 1.0, fn2imglist = 'stoic2021_case_info_split.csv',
                        img_dir=img_dir, prefix_dir = 'processed_lung', cv_fold = 0, split='train'))
...
load_from = 'work_dirs/resnset_s32c16em2_stoic2kcv05_192x192x144_2cls/best_auc_epoch_28_bce.pth'
...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/stoic2021/resnset_s32c16em2_stoic2kcv05_192x192x144_2cls_agecode.py 
# CUDA_VISIBLE_DEVICES=1,3 PORT=29135 bash ./tools/dist_train.sh configs/stoic2021/resnset_s32c16em2_stoic2kcv05_192x192x144_2cls_agecode.py 2
