_base_ = [
    '../_base_/models/convnext_s16c32k5em4_stoic_192x192x144_2cls.py',
    '../_base_/schedules/schedule_2x.py', '../_base_/default_runtime.py'
    # '../_base_/swa.py',
]

img_dir = 'data/STOIC2021Round1'
data = dict(samples_per_gpu = 14, workers_per_gpu= 14, 
...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/stoic2021/convnext_s16c32k5em4_stoic2kcv05_192x192x144_2cls_lungcen.py 
# CUDA_VISIBLE_DEVICES=4,5 PORT=29045 bash ./tools/dist_train.sh configs/stoic2021/convnext_s16c32k5em4_stoic2kcv05_192x192x144_2cls_lungcen.py 2
