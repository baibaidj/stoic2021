_base_ = [
    '../_base_/models/convnext_s32c32em4_stoic_192x192x160_img_covid_enage.py',
    '../_base_/schedules/schedule_2x.py', '../_base_/default_runtime.py'
    # '../_base_/swa.py',
]

img_dir = 'data/STOIC2021Round1'
data = dict(samples_per_gpu = 12, workers_per_gpu= 20, 
...
# CUDA_VISIBLE_DEVICES=4 python tools/train.py configs/stoic2021/convnext_s32c32em4_stoic2kcv05_192x192x160_covid_enage_pretrain.py 
# CUDA_VISIBLE_DEVICES=0,2,4 PORT=29024 bash ./tools/dist_train.sh configs/stoic2021/convnext_s32c32em4_stoic2kcv05_192x192x160_covid_enage_pretrain.py 3 --gpus 3
