...
data = dict(samples_per_gpu = 16, workers_per_gpu= 16, 
            train=dict(sample_rate = 1.0, fn2imglist = 'stoic2021_case_info_split.csv', 
                        img_dir=img_dir, prefix_dir = 'processed', cv_fold = 4), 
            ...
            test= dict(sample_rate = 1.0, fn2imglist = 'stoic2021_case_info_split.csv',
                        img_dir=img_dir, prefix_dir = 'processed', cv_fold = 4, split = 'train'))
...
load_from = 'work_dirs/resnset_s32c16em2_stoic2kcv45_256x224x224_2cls_agecode/latest.pth'
resume_from = None # 'work_dirs/resnset_s32c16em2_stoic2kcv45_256x224x224_2cls/latest.pth' 
...
# CUDA_VISIBLE_DEVICES=1 python tools/train.py configs/stoic2021/resnset_s32c16em2_stoic2kcv45_256x224x224_2cls_agecode.py 
# CUDA_VISIBLE_DEVICES=0,2,4 PORT=29024 bash ./tools/dist_train.sh configs/stoic2021/resnset_s32c16em2_stoic2kcv45_256x224x224_2cls_agecode.py 3
