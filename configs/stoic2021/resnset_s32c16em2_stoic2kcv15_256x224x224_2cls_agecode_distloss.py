...
load_from = 'work_dirs/resnset_s32c16em2_stoic2kcv15_256x224x224_2cls_agecode_ft/latest.pth'
...
# CUDA_VISIBLE_DEVICES=1 python tools/train.py configs/stoic2021/resnset_s32c16em2_stoic2kcv15_256x224x224_2cls_agecode_distloss.py 
# CUDA_VISIBLE_DEVICES=2,5 PORT=28225 bash ./tools/dist_train.sh configs/stoic2021/resnset_s32c16em2_stoic2kcv15_256x224x224_2cls_agecode_distloss.py 2
