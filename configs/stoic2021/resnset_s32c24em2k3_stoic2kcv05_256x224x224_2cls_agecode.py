_base_ = [
    '../_base_/models/resnet_s32c24em2k3_stoic_256x224x224_2cls.py',
...
model = dict(
        ...
        head = dict(
                    ...
                    age_encoding = dict(type='SineAgeEncoding', 
                            temperature=32,
                            num_feats=384, normalize=True, max_age = 6),
                    verb = False,
...
load_from = 'work_dirs/resnset_s32c24em2k3_stoic2kcv05_256x224x224_2cls/latest.pth'
resume_from = None # 'work_dirs/resnset_s32c24em2k3_stoic2kcv05_256x224x224_2cls/latest.pth' 

# optimizer
optimizer = dict(
                type='SGD', lr=8e-3, momentum=0.9, weight_decay=1e-3, 
...
# CUDA_VISIBLE_DEVICES=0 python tools/train.py configs/stoic2021/resnset_s32c24em2k3_stoic2kcv05_256x224x224_2cls_agecode.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29135 bash ./tools/dist_train.sh configs/stoic2021/resnset_s32c24em2k3_stoic2kcv05_256x224x224_2cls_agecode.py 3
