...
load_from = 'work_dirs/convnext_s32c32k5em4_stoic2kcv05_256x224x224_2cls_agecode/latest.pth'
...
optimizer = dict(
                ...
                _delete_ = True, type='AdamW', lr=6e-4, weight_decay=1e-3, 
                paramwise_cfg = dict(
...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/stoic2021/convnext_s32c32k5em4_stoic2kcv05_256x224x224_2cls_agecode_distloss.py 
# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29135 bash ./tools/dist_train.sh configs/stoic2021/convnext_s32c32k5em4_stoic2kcv05_256x224x224_2cls_agecode_distloss.py 3
