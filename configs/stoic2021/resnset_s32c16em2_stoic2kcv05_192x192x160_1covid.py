_base_ = [
    '../_base_/models/resnet_s32c16em2_stoic_192x192x144_1cls.py',
...
data = dict(samples_per_gpu = 12, workers_per_gpu= 12, 
            train=dict(sample_rate = 1.0, fn2imglist = 'stoic2021_case_info_split.csv', 
                        img_dir=img_dir, prefix_dir = 'processed_lung', cv_fold = 0, target_class = (0,)), 
...
load_from = None # 'work_dirs/resnset_s32c16em2_stoic2kcv05_192x192x160_covid_pretrain_lung/latest.pth'
resume_from = None # 'work_dirs/resnset_s32c16em2_stoic2kcv05_192x192x160_covid_pretrain_lung/latest.pth' 
...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/stoic2021/resnset_s32c16em2_stoic2kcv05_192x192x160_covid_pretrain_lung.py 
# CUDA_VISIBLE_DEVICES=0,2,4 PORT=29024 bash ./tools/dist_train.sh configs/stoic2021/resnset_s32c16em2_stoic2kcv05_192x192x160_covid_pretrain_lung.py 3 --gpus 3
