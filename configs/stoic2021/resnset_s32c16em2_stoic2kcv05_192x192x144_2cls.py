...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/stoic2021/resnset_s32c16em2_stoic2kcv05_192x192x144_2cls.py 
# CUDA_VISIBLE_DEVICES=1,3 PORT=29135 bash ./tools/dist_train.sh configs/stoic2021/resnset_s32c16em2_stoic2kcv05_192x192x144_2cls.py 2
