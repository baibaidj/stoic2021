_base_ = [
    '../_base_/models/simmim_convnext_s32c32k5em4_stoic_224x192x192_exp3.py',
...
model = dict(
        ...
        neck = dict(upsample_cfg=dict(type='upsample', mode='trilinear', use_norm = True),
                    verbose = False
                    ), 
...
load_from = None # 'work_dirs/simmim_convnext_s32c32em4_stoic_224x192x192_100eps_LN/latest.pth'
...
# 
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/selfup4med/simmim_convnext_s32c32k5em4_stoic_224x192x192_100eps_exp3.py --no-validate

# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29135 bash ./tools/dist_train.sh configs/selfup4med/simmim_convnext_s32c32k5em4_stoic_224x192x192_100eps_exp3.py 3 --no-validate
