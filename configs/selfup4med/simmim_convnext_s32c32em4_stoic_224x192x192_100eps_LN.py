_base_ = [
    '../_base_/models/simmim_convnext_s32c32k5em4_stoic_224x192x192_LN.py', # s32= stride32
...
model = dict(
        ...
        neck = dict(upsample_cfg=dict(type='deconv3d', mode=None, use_norm = True),
                    verbose = False
                    ), 
...
load_from = None # 'work_dirs/simmim_convnext_s16c32em4_lung_224x192x192_100eps/latest.pth'
...
# CUDA_VISIBLE_DEVICES=4 python tools/train.py configs/selfup4med/simmim_convnext_s32c32em4_stoic_224x192x192_100eps_LN.py --no-validate
