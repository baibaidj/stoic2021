...
# CUDA_VISIBLE_DEVICES=5 python tools/train.py configs/selfup4med/simmim_convnext_s32c32em4_lung_224x224x192_100eps.py --no-validate

# CUDA_VISIBLE_DEVICES=1,3,5 PORT=29135 bash ./tools/dist_train.sh configs/selfup4med/simmim_convnext_s32c32em4_lung_224x224x192_100eps.py 3 --gpus 3 --no-validate
